...
<div id="templatemo_wrapper"> 
    ...
    <div id="templatemo_content_wrapper">
		...
		$tpl = new Template("estrutura_editar_atividade.html"); 
		...
		if (isset($_POST["BtAlterar"])){
			...
			$result->setIdAtividade($_POST["IdAtividade"]);
			...
			$result->updateById($_GET['id']);
			
			$tpl->IDATIVIDADE = $result->getIdAtividade();
		...
		else 
		{
			...
			$tpl->IDNIVEL = $result->getIdNivel();
			$tpl->IDTIPOATIVIDADE = $result->getIdTipoAtividade();
			$tpl->INFO = "registo carregado com sucesso";
			$tpl->block("BLOCK_DADOS"); 
